...
class UserReceiveRewardTestCase(APITestCase):
    def setUp(self):
        ...
        """
        self.url = reverse("user_buy_product")
        self.user = User.objects.create(name="user-test")
        self.user_balance = UserBalance.objects.create(uid=self.user, balance=100000)

    def test_get_user_buy_product(self):
        """
        Test to make sure that user buy product topup API will not work with GET
        """
    ...
    def test_post_user_buy_product_permission_success(self):
        """
        Test to make sure that user buy product API will work with POST method if permission success
        """
        # Simulate successful server permission
        header = {"HTTP_SERVER_TOKEN": f"Token {settings.SERVER_TOKEN}"}
    ...
    def test_post_user_buy_product_permission_failed(self):
        """
        Test to make sure that user buy product API will not work if permission failed
        """
    ...
    def test_post_user_buy_product_body_incomplete(self):
        """
        Test to make sure that user buy product API will not work with uncomplete body
        """
        # Simulate successful server permission
        header = {"HTTP_SERVER_TOKEN": f"Token {settings.SERVER_TOKEN}"}
    ...
    def test_post_user_buy_product_invalid_body(self):
        """
    ...
    def test_put_user_buy_product(self):
        """
        Test to make sure user buy product API will not work with PUT method
        """
    ...
    def test_patch_user_buy_product(self):
        """
        Test to make sure user buy product API will not work with PATCH method
        """
